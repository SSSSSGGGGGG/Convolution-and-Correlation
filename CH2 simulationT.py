...
# Multiplication of FT fields with magnitude and phase, the complex conjugation operation is for cross-correaltion.
con1=FT_forward*FT_forward
cor1=FT_forward*np.conjugate(FT_forward)
# Inverse FFT of multiplication, where the reconstruction of convoluton and cross- correlations are obtained.
